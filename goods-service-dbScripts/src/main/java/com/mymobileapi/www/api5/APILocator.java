...
public class APILocator extends org.apache.axis.client.Service implements com.mymobileapi.www.api5.API {
    ...
    public com.mymobileapi.www.api5.APISoap getAPISoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.mymobileapi.www.api5.APISoapStub _stub = new com.mymobileapi.www.api5.APISoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.mymobileapi.www.api5.APISoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.mymobileapi.www.api5.APISoapStub _stub = new com.mymobileapi.www.api5.APISoapStub(new java.net.URL(APISoap_address), this);
                _stub.setPortName(getAPISoapWSDDServiceName());
                return _stub;
            }
        }
